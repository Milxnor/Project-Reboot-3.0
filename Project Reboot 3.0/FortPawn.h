...
void AFortPawn::OnRep_CosmeticLoadout()
{
	static auto OnRep_CosmeticLoadoutFn = FindObject<UFunction>(L"/Script/FortniteGame.FortPlayerPawn.OnRep_CosmeticLoadout");
	this->ProcessEvent(OnRep_CosmeticLoadoutFn);
}
