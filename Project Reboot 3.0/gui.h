                        ...
                        if (ImGui::Button("Start Bus")) {
                            ...
                            if (Globals::bLateGame.load()) {
                                ...
                                for (int z = 0; z < ClientConnections.Num(); z++) {
                                    ...
                                    static auto SMG = FindObject<UFortItemDefinition>(
                                    ...
                                    static auto MiniShields = FindObject<UFortItemDefinition>(
