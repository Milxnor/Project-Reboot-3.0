...
static inline std::string wstring_to_utf8(const std::wstring &str) {
    if (str.empty()) return {};
    const auto size_needed = WideCharToMultiByte(CP_UTF8, 0, &str[0], static_cast<int>(str.size()), nullptr, 0, nullptr,
                                                 nullptr);
...
static inline void StaticUI() {
    if (IsRestartingSupported()) {
        ...
        if (Globals::bAutoRestart) {
            ImGui::InputFloat(
                    std::format("How long after {} players join the bus will start", NumRequiredPlayersToStart).c_str(),
                    &AutoBusStartSeconds);
        ...
        if (Tab == GAME_TAB) {
                ...
                if (!bStartedBus) {
                            ...
                            if (Globals::bLateGame.load()) {
                                auto GetAircrafts = [&]() -> TArray<AActor *> {
                                    ...
                                    if (AircraftsOffset == -1) {
                                        ...
                                        static auto FortAthenaAircraftClass = FindObject<UClass>(
                                                L"/Script/FortniteGame.FortAthenaAircraft");
                                        auto AllAircrafts = UGameplayStatics::GetAllActorsOfClass(GetWorld(),
                                                                                                  FortAthenaAircraftClass);
                                ...
                                static auto NextNextCenterOffset = GameState->Get(SafeZoneIndicatorOffset)->GetOffset(
                                        "NextNextCenter", false);
                                static auto NextCenterOffset = GameState->Get(SafeZoneIndicatorOffset)->GetOffset(
                                        "NextCenter");
                                FVector LocationToStartAircraft = GameState->Get(SafeZoneIndicatorOffset)->Get<FVector>(
                                        NextNextCenterOffset == -1 ? NextCenterOffset
                                ...
                                for (int i = 0; i < GetAircrafts().Num(); i++) {
                                    ...
                                    if (FlightInfoOffset == -1) {
                                        static auto FlightStartLocationOffset = CurrentAircraft->GetOffset(
                                                "FlightStartLocation");
                                        ...
                                        CurrentAircraft->Get<FVector>(
                                                FlightStartLocationOffset) = LocationToStartAircraft;
                                        CurrentAircraft->Get<float>(FlightSpeedOffset) = FlightSpeed;
                                        CurrentAircraft->Get<float>(
                                                DropStartTimeOffset) = GameState->GetServerWorldTimeSeconds();
                                    } else {
                                        auto FlightInfo = CurrentAircraft->GetPtr<FAircraftFlightInfo>(
                                                FlightInfoOffset);
                                ...
                                if (MapInfo) {
                                    ...
                                    if (FlightInfosOffset != -1) {
                                        auto &FlightInfos = MapInfo->Get<TArray<FAircraftFlightInfo>>(
                                                FlightInfosOffset);

                                        LOG_INFO(LogDev, "FlightInfos.Num(): {}", FlightInfos.Num());

                                        for (int i = 0; i < FlightInfos.Num(); i++) {
                                            auto FlightInfo = FlightInfos.AtPtr(i,
                                                                                FAircraftFlightInfo::GetStructSize());
                                ...
                                static auto bAircraftIsLockedFieldMask = GetFieldMask(
                                        GameState->GetProperty("bAircraftIsLocked"));
                                ...
                                for (int z = 0; z < ClientConnections.Num(); z++) {
                                    ...
                                    static auto Shells = FindObject<UFortItemDefinition>(
                                            L"/Game/Athena/Items/Ammo/AthenaAmmoDataShells.AthenaAmmoDataShells");
                                    static auto Medium = FindObject<UFortItemDefinition>(
                                            L"/Game/Athena/Items/Ammo/AthenaAmmoDataBulletsMedium.AthenaAmmoDataBulletsMedium");
                                    static auto Light = FindObject<UFortItemDefinition>(
                                            L"/Game/Athena/Items/Ammo/AthenaAmmoDataBulletsLight.AthenaAmmoDataBulletsLight");
                                    static auto Heavy = FindObject<UFortItemDefinition>(
                                            L"/Game/Athena/Items/Ammo/AthenaAmmoDataBulletsHeavy.AthenaAmmoDataBulletsHeavy");

                                    static auto HeavySniper = FindObject<UFortItemDefinition>(
                                            L"/Game/Athena/Items/Weapons/WID_Sniper_Heavy_Athena_SR_Ore_T03.WID_Sniper_Heavy_Athena_SR_Ore_T03");

                                    static auto Shockwave = FindObject<UFortItemDefinition>(
                                            L"/Game/Athena/Items/Consumables/ShockwaveGrenade/Athena_ShockGrenade.Athena_ShockGrenade");

                                    static auto Hunting = FindObject<UFortItemDefinition>(
                                            L"/Game/Athena/Items/Weapons/LTM/WID_Sniper_NoScope_Athena_SR_Ore_T03.WID_Sniper_NoScope_Athena_SR_Ore_T03");

                                    static auto CrashPad = FindObject<UFortItemDefinition>(
                                    ...
                                    WorldInventory->AddItem(Shockwave, nullptr, 100);
                                    WorldInventory->AddItem(CrashPad, nullptr, 100);
                                ...
                                if (SafeZoneIndicator) {
                                    UKismetSystemLibrary::ExecuteConsoleCommand(GetWorld(), L"startshrinksafezone",
                                                                                nullptr);
                                ...
                                for (int z = 0; z < ClientConnections.Num(); z++) {
                                    ...
                                    if (Fortnite_Version >= 19.10 && Fortnite_Version <= 19.40) {
                                        ...
                                        static auto HunterBolt = FindObject<UFortItemDefinition>(
                                                L"/FlipperGameplay/Items/Weapons/CoreSniper/WID_Sniper_CoreSniper_Athena_SR.WID_Sniper_CoreSniper_Athena_SR");

                                        WorldInventory->AddItem(WebShooter, nullptr, 1);
                                        WorldInventory->AddItem(HunterBolt, nullptr, 1);
                                        WorldInventory->Update();
                                    }
                                    ...
                                    if (Fortnite_Version >= 13.00 && Fortnite_Version <= 17.50) {
                                        ...
                                        WorldInventory->AddItem(JulesGrappler, nullptr, 1);
                                        WorldInventory->AddItem(HeavySniper, nullptr, 1);
                                        WorldInventory->Update();
                                    }
                    ...
                    else if (ImGui::Button("Start Bus Countdown"))
                    {
                        ...
                        if (Fortnite_Version == 1.11) {
                            static auto OverrideBattleBusSkin = FindObject(
                                    L"/Game/Athena/Items/Cosmetics/BattleBuses/BBID_WinterBus.BBID_WinterBus");
                            ...
                            if (OverrideBattleBusSkin) {
                                ...
                                if (AssetManager) {
                                    ...
                                    if (AthenaGameData) {
                                        static auto DefaultBattleBusSkinOffset = AthenaGameData->GetOffset(
                                                "DefaultBattleBusSkin");
                                ...
                                static auto FortAthenaAircraftClass = FindObject<UClass>(
                                        "/Script/FortniteGame.FortAthenaAircraft");
                                auto AllAircrafts = UGameplayStatics::GetAllActorsOfClass(GetWorld(),
                                                                                          FortAthenaAircraftClass);
                                ...
                                for (int i = 0; i < AllAircrafts.Num(); i++) {
                                    ...
                                    static auto SpawnedCosmeticActorOffset = Aircraft->GetOffset(
                                            "SpawnedCosmeticActor");
                        ...
                        static auto WarmupEarlyCountdownDurationOffset = GameMode->GetOffset(
                    ...
                    else if (ImGui::Button("Start Bus Countdown"))
                    {
                        ...
                        for (int z = 0; z < ClientConnections.Num(); z++)
                        {
                            ...
                            static auto Shockwave = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/ShockwaveGrenade/Athena_ShockGrenade.Athena_ShockGrenade");
                            static auto HeavySniper = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/WID_Sniper_Heavy_Athena_SR_Ore_T03.WID_Sniper_Heavy_Athena_SR_Ore_T03");
                            static auto JulesGrappler = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Weapons/Boss/WID_Boss_GrapplingHoot.WID_Boss_GrapplingHoot");
                            static auto CrashPad = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/AppleSun/WID_Athena_AppleSun.WID_Athena_AppleSun");
                            static auto Splash = FindObject<UFortItemDefinition>(L"/Game/Athena/Items/Consumables/ChillBronco/Athena_ChillBronco.Athena_ChillBronco");
                            ...
                            WorldInventory->AddItem(Shockwave, nullptr, 999);
                            WorldInventory->AddItem(HeavySniper, nullptr, 1);
                            WorldInventory->AddItem(JulesGrappler, nullptr, 1);
                            WorldInventory->AddItem(CrashPad, nullptr, 300);
                            WorldInventory->AddItem(Splash, nullptr, 300);
            ...
            if (Fortnite_Version == 8.51) {
                if (ImGui::Button("Unvault DrumGun")) {
                    static auto SetUnvaultItemNameFn = FindObject<UFunction>(
                    ...
                    if (EventScripting) {
                        ...
                        static auto PillarsConcludedFn = FindObject<UFunction>(
            ...
            if (ImGui::Button("Dump Objects")) {
                auto ObjectNum = ChunkedObjects ? ChunkedObjects->Num() : UnchunkedObjects ? UnchunkedObjects->Num()
                                                                                           : 0;
            ...
            if (ImGui::Button("Dump Skins (Skins.txt)")) {
                ...
                if (SkinsFile.is_open()) {
                    ...
                    for (int i = 0; i < AllObjects.size(); i++) {
                        ...
                        FString DisplayNameFStr = UKismetTextLibrary::Conv_TextToString(
                                CurrentCID->Get<FText>(DisplayNameOffset));
            ...
            if (ImGui::Button("Dump Playlists (Playlists.txt)")) {
                ...
                if (PlaylistsFile.is_open()) {
                    ...
                    for (int i = 0; i < AllObjects.size(); i++) {
                        ...
                        FString PlaylistNameFStr = UKismetTextLibrary::Conv_TextToString(
                                Object->Get<FText>(UIDisplayNameOffset));
                ...
                if (WeaponsFile.is_open()) {
                    ...
                    auto DumpItemDefinitionClass = [&WeaponsFile](UClass *Class) {
                        ...
                        for (int i = 0; i < AllObjects.size(); i++) {
                            ...
                            FString ItemDefinitionFStr = UKismetTextLibrary::Conv_TextToString(
                                    Object->Get<FText>(DisplayNameOffset));
            ...
            if (ImGui::Button("Give Item to Everyone")) {
                ...
                if (ItemDefinition) {
                    ...
                    for (int i = 0; i < ClientConnections.Num(); i++) {
                        auto PlayerController = Cast<AFortPlayerController>(
                                ClientConnections.at(i)->GetPlayerController());
            ...
            if (ImGui::Button("Print Class VFT")) {
                ...
                if (Class) {
                    ...
                    if (ClassToDump) {
                        LOG_INFO(LogDev, "{} VFT: 0x{:x}", ClassToDump->GetName(),
                                 __int64(ClassToDump->VFTable) - __int64(GetModuleHandleW(0)));
                    }
                }
            }
            ...
            if (ImGui::Button("Print Function Exec Addr")) {
                ...
                if (Function) {
                    LOG_INFO(LogDev, "{} Exec: 0x{:x}", Function->GetName(),
                             __int64(Function->GetFunc()) - __int64(GetModuleHandleW(0)));
                }
            }
...
GuiThread(LPVOID)
        {
            ...
            sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(
                    NULL), NULL, NULL, NULL, NULL, L"RebootClass", NULL
        };
        ::RegisterClassEx(&wc);
...
static inline bool CreateDeviceD3D(HWND
hWnd)
{
if ((
...
g_d3dpp.
PresentationInterval = D3DPRESENT_INTERVAL_ONE;           // Present with vsync
...
{
g_d3dpp.
BackBufferWidth = LOWORD(lParam);
g_d3dpp.
BackBufferHeight = HIWORD(lParam);
